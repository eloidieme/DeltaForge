...
Output goes to packs/flashindex/stages/12_parallel_performance/fixtures/bench_codebase
...
def main() -> None:
    ...
    out = (
        root
        / "packs/flashindex/stages/12_parallel_performance/fixtures/bench_codebase"
    )
    if out.exists():
        shutil.rmtree(out)
