...
<style>{theme_tokens}{css}{input_css}{theme_unify}</style>
</head>
...
<header class="topbar">
  ...
  <nav class="site-nav" aria-label="DeltaForge pages"><a class="site-link" href="learning.html">Learn</a><a class="site-link current" aria-current="page" href="test-report.html">Test report</a></nav>
